...
class ResponseInitiative{
     ...
     * @return string
     */
    public static function text($tousername, $content, $public_id){
        //获取ACCESS_TOKEN
        $accessToken = AccessToken::getAccessToken($public_id);
     ...
     * @return string
     */
    public static function image($tousername, $mediaId, $public_id){
        //获取ACCESS_TOKEN
        $accessToken = AccessToken::getAccessToken($public_id);
        self::$queryUrl = self::$queryUrl.$accessToken;
     ...
     * @return string
     */
    public static function voice($tousername, $mediaId, $public_id){
        //获取ACCESS_TOKEN
        $accessToken = AccessToken::getAccessToken($public_id);
        self::$queryUrl = self::$queryUrl.$accessToken;
     ...
     * @return string
     */
    public static function video($tousername, $mediaId, $title, $description, $public_id){
        //获取ACCESS_TOKEN
        $accessToken = AccessToken::getAccessToken($public_id);
        self::$queryUrl = self::$queryUrl.$accessToken;
     ...
     * @return string
     */
    public static function music($tousername, $title, $description, $musicUrl, $hqMusicUrl, $thumbMediaId, $public_id){
        //获取ACCESS_TOKEN
        $accessToken = AccessToken::getAccessToken($public_id);
        self::$queryUrl = self::$queryUrl.$accessToken;
     ...
     * @return string
     */
    public static function news($tousername, $item, $public_id){
        //获取ACCESS_TOKEN
        $accessToken = AccessToken::getAccessToken($public_id);
        self::$queryUrl = self::$queryUrl.$accessToken;
