...
class IntelligentInterface{
     ...
     */
    public static function semanticSemproxy($query, $category, $openId, $public_id, $latitude='', $longitude='', $region='', $city=''){
        $queryUrl = 'https://api.weixin.qq.com/semantic/semproxy/search?access_token='.AccessToken::getAccessToken($public_id);
        $queryAction = 'POST';
        $template = array();
...
//        $template['appid'] = WECHAT_APPID;
        $template['appid'] = Weixin::get_appid($public_id);
