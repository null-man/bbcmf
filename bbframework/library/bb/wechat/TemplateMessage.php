...
class TemplateMessage{
    ...
    public static function setIndustry($industryId1, $industryId2, $public_id){
        $queryUrl = 'https://api.weixin.qq.com/cgi-bin/template/api_set_industry?access_token='.AccessToken::getAccessToken($public_id);
        $queryAction = 'POST';
        $template = array();
    ...
    public static function getTemplateId($templateIdShort, $public_id){
        $queryUrl = 'https://api.weixin.qq.com/cgi-bin/template/api_add_template?access_token='.AccessToken::getAccessToken($public_id);
        $queryAction = 'POST';
        $template = array();
    ...
    public static function sendTemplateMessage($data, $touser, $templateId, $url, $public_id, $topcolor='#FF0000'){
        $queryUrl = 'https://api.weixin.qq.com/cgi-bin/message/template/send?access_token='.AccessToken::getAccessToken($public_id);
        $queryAction = 'POST';
        $template = array();
