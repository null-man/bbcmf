...
class WechatRequest {
     ...
     * @return array|string
     */
    public static function switchType(&$request, $public_id){
        $data = array();

//        $log['fromusername'] = $request['fromusername'];
//        $log['tousername'] = $request['tousername'];
//        $log['type'] = $request['msgtype'];
//        Db::table('test_log')->save();
        ...
        switch ($request['msgtype']) {
            ...
            //文本
            case 'text':
                $data = self::text($request, $public_id);
                break;
            //图像
            case 'image':
     ...
     * @return array
     */
    public static function text(&$request, $public_id){
        $content = '收到文本消息';
//        $publicinfo = Weixin::get_publicinfo($public_id);
//         $content = '收到文本消息: '.$request['content'].'_'.$publicinfo['name'];
