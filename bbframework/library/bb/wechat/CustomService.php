...
Class CustomService{
     ...
     */
    public function addAccount($kfAccount, $nickname, $password, $public_id){
        $queryUrl = 'https://api.weixin.qq.com/customservice/kfaccount/add?access_token='.AccessToken::getAccessToken($public_id);
        $queryAction = 'POST';
        $template = array();
     ...
     * @return array( "errcode" : 0, "errmsg" : "ok")
     */
    public function editAccount($kfAccount, $nickname, $password, $public_id){
        $queryUrl = 'https://api.weixin.qq.com/customservice/kfaccount/update?access_token='.AccessToken::getAccessToken($public_id);
        $queryAction = 'POST';
        $template = array();
        $template['kf_account'] = $kfAccount;
        $template['nickname'] = $nickname;
     ...
     * @return array( "errcode" : 0, "errmsg" : "ok")
     */
    public function delAccount($kfAccount, $nickname, $password, $public_id){
        $queryUrl = 'https://api.weixin.qq.com/customservice/kfaccount/del?access_token='.AccessToken::getAccessToken($public_id);
        $queryAction = 'POST';
        $template = array();
        $template['kf_account'] = $kfAccount;
        $template['nickname'] = $nickname;
     ...
     * ))
     */
    public function getAccountList($kfAccount, $nickname, $password, $public_id){
        $queryUrl = 'https://api.weixin.qq.com/cgi-bin/customservice/getkflist?access_token='.AccessToken::getAccessToken($public_id);
        $queryAction = 'GET';
        $template = array();
        $template['kf_account'] = $kfAccount;
        $template['nickname'] = $nickname;
     ...
     * @return array( "errcode" : 0, "errmsg" : "ok")
     */
    public function setAccountImage($kfAccount, $imagePath, $public_id){
        if(!file_exists($imagePath)){
            return false;
        }
        //获取ACCESS_TOKEN
        $queryUrl = 'http://api.weixin.qq.com/customservice/kfaccount/uploadheadimg?access_token='.AccessToken::getAccessToken($public_id).'&kf_account='.$kfAccount;
        $data = array();
     ...
     */
    public function getRecord($startTime, $endTime, $public_id, $pageIndex=1, $pageSize=1000, $openId=''){
        $queryUrl = 'https://api.weixin.qq.com/cgi-bin/customservice/getrecord?access_token='.AccessToken::getAccessToken($public_id);
        $queryAction = 'POST';
        $template = array();
