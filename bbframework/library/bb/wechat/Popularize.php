...
class Popularize{
     ...
     * )
     */
    public static function createTicket($type, $expireSeconds, $sceneId, $public_id){
        $queryUrl = 'https://api.weixin.qq.com/cgi-bin/qrcode/create?access_token='.AccessToken::getAccessToken($public_id);
        $queryAction = 'POST';
        $template = array();
        if($type == 1){
     ...
     */
    public static function long2short($longUrl, $public_id){
        $queryUrl = 'https://api.weixin.qq.com/cgi-bin/shorturl?access_token='.AccessToken::getAccessToken($public_id);
        $queryAction = 'POST';
        $template = array();
